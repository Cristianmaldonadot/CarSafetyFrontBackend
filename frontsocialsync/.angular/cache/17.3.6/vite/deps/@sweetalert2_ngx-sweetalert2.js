...
var SweetAlert2LoaderService = class _SweetAlert2LoaderService {
  ...
  static ɵfac = function SweetAlert2LoaderService_Factory(t) {
    return new (t || _SweetAlert2LoaderService)(ɵɵinject(swalProviderToken));
  };
...
var SwalComponent = class _SwalComponent {
  ...
  static ɵfac = function SwalComponent_Factory(t) {
    return new (t || _SwalComponent)(ɵɵdirectiveInject(SweetAlert2LoaderService), ɵɵdirectiveInject(fireOnInitToken), ɵɵdirectiveInject(dismissOnDestroyToken));
  };
...
var SwalDirective = class _SwalDirective {
  ...
  static ɵfac = function SwalDirective_Factory(t) {
    return new (t || _SwalDirective)(ɵɵdirectiveInject(ViewContainerRef), ɵɵdirectiveInject(ComponentFactoryResolver$1));
  };
...
var SwalPortalComponent = class _SwalPortalComponent {
  ...
  static ɵfac = function SwalPortalComponent_Factory(t) {
    return new (t || _SwalPortalComponent)();
  };
  static ɵcmp = ɵɵdefineComponent({
...
var SwalPortalTargets = class _SwalPortalTargets {
  ...
  static ɵfac = function SwalPortalTargets_Factory(t) {
    return new (t || _SwalPortalTargets)();
  };
  static ɵprov = ɵɵdefineInjectable({
...
var SwalPortalDirective = class _SwalPortalDirective {
  ...
  static ɵfac = function SwalPortalDirective_Factory(t) {
    return new (t || _SwalPortalDirective)(ɵɵdirectiveInject(ComponentFactoryResolver$1), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(ApplicationRef), ɵɵdirectiveInject(TemplateRef), ɵɵdirectiveInject(SweetAlert2LoaderService), ɵɵdirectiveInject(SwalPortalTargets), ɵɵdirectiveInject(SwalComponent, 1));
  };
  static ɵdir = ɵɵdefineDirective({
    type: _SwalPortalDirective,
    selectors: [["", "swalPortal", ""]],
    inputs: {
      target: [InputFlags.None, "swalPortal", "target"]
    }
  });
};
(() => {
...
var SweetAlert2Module = class _SweetAlert2Module {
  ...
  static ɵfac = function SweetAlert2Module_Factory(t) {
    return new (t || _SweetAlert2Module)();
  };
